...
public class ORDSTests {
    ...
    private String baseURI = "http://ec2-54-91-164-145.compute-1.amazonaws.com:1000/ords/hr";
    ...
    public void test2(){
        ...
        //in this example, we are specifing what kind of response type we need
        //because web service can return lets say json or xml
        //when we put header info "Accept","application/json", we r saying that we need only json as response
    ...
    //Task :  performe GEt request to regions, print body all headers
    @Test
    public void test3(){
